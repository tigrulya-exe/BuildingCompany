...
import MaterialsSelectTable from "../readOnlyTables/MaterialsSelectTable";


export default class MaterialsWithExceedance extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            areaIds: '',
        ...
        return (
            <>
                ...
                <MaterialsSelectTable
                    url='/materials/by-area-management-exceedance'
                    params={{
